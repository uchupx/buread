<template>
  <div class="min-h-screen from-slate-50 to-slate-100 dark:from-slate-950 dark:to-slate-900 pt-20 pb-20">
    <TopNavbar/>
    <BottomNavbar/>
              ...
              <CardContent>
                ...
                <div class="mt-6 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg space-y-2 text-sm">
                  ...
                  <div class="grid grid-cols-2 gap-2 text-gray-600 dark:text-gray-400">
                    ...
                    <span>Font: <span class="font-semibold">{{
